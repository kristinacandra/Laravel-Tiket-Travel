@extends('layout')
@section('content')
<h3 class>EDIT DATA PESANAN TIKET KERETA API</h3>
<form action="{{ route('peskereta.update', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <a href="{{route('peskereta')}}" class="btn btn-secondary">Kembali</a>
