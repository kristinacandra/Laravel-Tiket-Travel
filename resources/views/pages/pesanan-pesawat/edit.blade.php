@extends('layout')
@section('content')
<h3 class>EDIT DATA PESANAN TIKET PESAWAT</h3>
<form action="{{ route('pespesawat.update', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <a href="{{route('pespesawat')}}" class="btn btn-secondary">Kembali</a>
